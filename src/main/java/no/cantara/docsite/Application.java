...
import no.cantara.docsite.fetch.ScheduledFetchData;
...
public class Application {
    ...
    public void enableScheduledExecutorService() {
        ScheduledFetchData scheduledFetchData = new ScheduledFetchData(configuration, executorService, scheduledExecutorService, cacheStore);
        scheduledFetchData.run();
